...
- [目录](#目录)
- [1. git与github](#1-git与github)
  - [1.1 git的安装](#11-git的安装)
  - [1.2 github的使用](#12-github的使用)
  - [1.3 SSH绑定](#13-ssh绑定)
- [2. git常用命令](#2-git常用命令)
  - [2.1 创建版本库](#21-创建版本库)
    - [2.1.1 git clone](#211-git-clone)
    - [2.1.2 git init](#212-git-init)
  - [2.2 修改与提交](#22-修改与提交)
    - [2.2.1 git status](#221-git-status)
    - [2.2.2 git diff](#222-git-diff)
    - [2.2.3 git add](#223-git-add)
    - [2.2.4 git mv](#224-git-mv)
    - [2.2.5 git rm](#225-git-rm)
    - [2.2.6 git commit](#226-git-commit)
  - [2.3 撤消](#23-撤消)
    - [2.3.1 git reset](#231-git-reset)
    - [2.3.2 git revert](#232-git-revert)
    - [2.3.3 git checkout](#233-git-checkout)
  - [2.4 分支与标签](#24-分支与标签)
    - [2.4.1 git branch](#241-git-branch)
    - [2.4.2 git tag](#242-git-tag)
  - [2.5 合并与衍合](#25-合并与衍合)
    - [2.5.1 git merge](#251-git-merge)
    - [2.5.2 git rebase](#252-git-rebase)
  - [2.6 远程操作](#26-远程操作)
    - [2.6.1 git remote](#261-git-remote)
    - [2.6.2 git fetch](#262-git-fetch)
    - [2.6.3 git pull](#263-git-pull)
    - [2.6.4 git push](#264-git-push)
- [3. git进阶用法](#3-git进阶用法)
- [4. 日常debug总结](#4-日常debug总结)
  - [4.1 新建repo](#41-新建repo)
  - [4.2 将本地repo绑定远程repo](#42-将本地repo绑定远程repo)
  - [4.3 屏蔽某文件/目录](#43-屏蔽某文件目录)
...
|                           标题处理                           |                           源码符号                           |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| 标题由纯中文或者英文组合，**不含特殊符号**，直接`#`接标题名称。 |         如`目录`，则：`[Menu](#目录)`，[Menu](#目录)         |
